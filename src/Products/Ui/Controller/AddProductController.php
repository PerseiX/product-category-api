...
final class AddProductController
{
    ...
    public function __invoke(Request $request): Response
    {
        ...
        return match ($result->getReason()) {
            ...
            'category_is_required' => new JsonResponse(['message' => 'Category is required'], Response::HTTP_BAD_REQUEST),
            ...
            default => new JsonResponse(['message' => 'Failed to add product'], Response::HTTP_INTERNAL_SERVER_ERROR)
        };
    }
}